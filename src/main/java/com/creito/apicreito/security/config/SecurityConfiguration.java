package com.creito.apicreito.security.config;

import com.creito.apicreito.security.JwtAuthenticationEntryPoint;
import com.creito.apicreito.security.JwtAuthenticationTokenFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and().sessionManagement()
                ...
                .antMatchers("/auth/**", "/refresh", "/configuration/security", "/webjars/**", "/users/**")
