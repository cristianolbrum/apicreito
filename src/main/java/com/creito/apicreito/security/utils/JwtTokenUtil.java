package com.creito.apicreito.security.utils;
...
public class JwtTokenUtil {
    ...
    public final String CLAIN_KEY_ROLE = "role";
    public final String CLAIN_KEY_AUDIENCE = "audience";
    ...
    public  String getUsernamesFromToken(String token){
        String username;
        try{
